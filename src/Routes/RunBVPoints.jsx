        ...
        <div className='w-full bg-[#1E1E1E] h-full fixed right-0 flex flex-col '>
            ...
            <div className='res-body lg:ml-[300px] md:ml-[100px]  flex flex-col'>
                ...
                <div className='flex flex-col dash-body w-full h-screen p-8 overflow-y-scroll' id="style-6">
                    <h2 className='text-[24px] font-semibold text-white'>Run BV Points</h2>
                    <h3 className='text-[18px] font-normal text-[#E08E20]'>Dashboard > Run BV Points</h3>
                            ...
                            <div className='w-full flex flex-wrap gap-5 justify-center'>
                                {bvPoints.map((div, index) => {
                                    ...
                                    return (
                                        <div
                                            key={index}
                                            className={`w-2/12 h-[128px] rounded-md border-[1px] cursor-pointer justify-center items-center flex flex-row space-x-5 relative overflow-hidden bg-[#151515]`}
                                        >
